...
%------------------------------------------------------------------------------%
\begin{teorema}{Teorema de Weierstrass}{teo:weistress}
  Se\index{Teorema!Weierstrass}
  $f$ for contínua em um intervalo fechado $[a, b]$, então $f$ assume um
  valor máximo global $f(c)$ e um valor mínimo global $f(d)$ em pontos
  $c$, $d \in[a, b]$.
\end{teorema}
%------------------------------------------------------------------------------%
