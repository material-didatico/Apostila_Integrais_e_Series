...
\makeHeader{Integrais e Séries}{Prova Substitutiva -- Turma 6}{21/02/2025}
...
\((0, 0)\), \((1, 1)\) e \((2, -1)\) em torno da reta \(x=-1\)
...
\begin{enumerate}[label=\alph*)]
  ...
  \begin{align*}
    ...
    & = \sum_{n=1}^\infty \frac{f^{(n)}(1)}{n!}(x-1)^n \\
    & = \sum_{n=1}^\infty \frac{(-1)^n(n-1)!}{2^n} \frac{(x-1)^n}{n!} \\
    & = \sum_{n=1}^\infty \frac{(-1)^n}{n2^n} (x-1)^n
  \end{align*}

  \item
  \[
    \abs{a_n}
    = \abs{\frac{(-1)^n}{n2^n} (x-1)^n}
    = \frac{\abs{x-1}^n}{n2^n}
  \]
  \[
    \abs{a_{n+1}}
    = \abs{\frac{(-1)^{n+1}}{(n+1)2^{n+1}} (x-1)^{n+1}}
    = \frac{\abs{x-1}^{n+1}}{(n+1)2^{n+1}}
  \]
  \begin{align*}
    \rho
    & = \lim \frac{\abs{a_{n+1}}}{\abs{a_n}} \\
    & = \lim \frac{\abs{x-1}^{n+1}}{(n+1)2^{n+1}} \; \frac{n2^n}{\abs{x-1}^n} \\
    & = \lim \frac{\abs{x-1}}{2} \; \frac{n}{n+1} \\
    & = \frac{\abs{x-1}}{2} \lim \frac{n}{n+1} \\
    & = \frac{\abs{x-1}}{2}
  \end{align*}

  \vspace{\baselineskip}
  A série converge absolutamente no intervalo definido por $\rho<1$
  \begin{align*}
    \rho & < 1 \\
    \frac{\abs{x-1}}{2} & < 1 \\
    \abs{x-1} & < 2 \\
  ...
  \begin{align*}
    P_3(x)
    & = \sum_{n=1}^3 \frac{(-1)^n}{n2^n} (x-1)^n \\
    & = \frac{(-1)^1}{1\times 2^1} (x-1)^1
      + \frac{(-1)^2}{2\times 2^2} (x-1)^2
      + \frac{(-1)^3}{3\times 2^3} (x-1)^3 \\
    & = - \frac{1}{2}  (x-1)
        + \frac{1}{8}  (x-1)^2
        - \frac{1}{24} (x-1)^3
  \end{align*}
  ...
  \[
    ...
    \qquad c \text{ entre } a \text{ e } x
  \]
  \[
    R_3(x)
    = \frac{f^{(4)}(c)}{4!}(x-1)^4
    = \frac{(-1)^4(4-1)!}{(3-c)^4\,4!}(x-1)^4
    = \frac{(x-1)^4}{4(3-c)^4}
    \qquad c \text{ entre } 1 \text{ e } x
  \]
  \[
    R_3(2)
    = \frac{(2-1)^4}{4(3-c)^4}
    = \frac{1}{4(3-c)^4}
    \qquad c \text{ entre } 1 \text{ e } 2
  \]
  \[
    \abs{R_3(2)}
    = \frac{1}{4\abs{3-c}^4}
