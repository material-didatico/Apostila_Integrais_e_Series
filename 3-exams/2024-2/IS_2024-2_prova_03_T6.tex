...
\makeHeader{Integrais e Séries}{Prova 3 -- Turma 6}{14/01/2024}
...
%------------------------------------------------------------------------------%
\exercise{25}
Calcule o limite a sequência de somas parciais da série \;
\(
  \sum_{n=1}^{\infty} \frac{\sqrt{2}}{n^2 + n}
\)
...
\(
  \sum_{n=1}^\infty \frac{n^3 - 5n + 1}{(n-2)(n^2+3)n^2}
\)
...
\) \;
é convergente e determine quantos termos precisam ser somados
para garantir um erro menor do que $10^{-6}$
