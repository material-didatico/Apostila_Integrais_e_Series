...
Algumas propriedades importantes das funções deriváveis são o
Teorema de Rolle e o Teorema do Valor Médio.

%------------------------------------------------------------------------------%
\begin{teorema}{Teorema de Rolle}{teo:rolle}
  Suponha\index{Teorema!de Rolle}
  que $f$ é uma função
  \begin{enumerate}
...
%------------------------------------------------------------------------------%
\begin{teorema}{Teorema do valor médio}{teo:tvm}
  Suponha\index{Teorema!valor médio}
  que $f$ é uma função
  \begin{enumerate}
    \item contínua  no intervalo fechado $[a, b]$
    \item derivável no intervalo aberto  $(a, b)$
  \end{enumerate}
  então existe $c\in(a, b)$ tal que
  \[
