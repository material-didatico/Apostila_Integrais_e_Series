...
\begin{mathlist}
  ...
  \item h(x)=\int_x^1 (\cos(\sqrt{t}))dt
...
%------------------------------------------------------------------------------%
\begin{exercise}
Se $f(x)= \int_0^{\sin(t)} \sqrt{1+t^2} dt$ e $g(y)= \int_3^y f(x)dx$,
encontre $g''(\frac{\pi}{6})$.
\begin{answer}
  $\frac{\sqrt{15}}{4}$
\end{answer}
\end{exercise}
...
\begin{mathlist}
  ...
  \item \int_1^8 \frac{1}{x^{\frac{2}{3}}}dx
  \item \int_{\frac{\pi}{6}}^{\pi}\sin(x) dx
  ...
  \item \int_{\frac{1}{\sqrt{3}}}^{\sqrt{3}} \frac{8}{1+v^2} dv
  ...
  \item \int_0^1 x(\sqrt[3]{x}+ \sqrt[4]{x})dx
  \item \int_{0}^{\frac{\pi}{3}} \frac{\sin(\theta)+\sin(\theta) \tan(\theta)}{\sec^2(\theta)} d\theta
  \item \int_0^{\frac{1}{\sqrt{3}}} \frac{t^2-1}{t^4-1}dt
  \item \int_1^4 \frac{\sqrt{y}-y}{y^2}dy
  \item \int_0^2 \vert 2x-1 \vert dx
...
\begin{mathlist}
  ...
  \item \int_{\frac{\pi}{4}}^{\frac{\pi}{3}} \tan(x)dx
\end{mathlist}
\begin{answer}
  \begin{mathlist}
    \item 0 \leq \int_{0}^2 xe^{-x} dx \frac{1}{e}
    \item \frac{\pi}{12} \leq \int_{\frac{\pi}{4}}^{\frac{\pi}{3}} \tan(x)dx \leq \frac{\pi}{2} \sqrt{3}
  \end{mathlist}
\end{answer}
\end{exercise}
%------------------------------------------------------------------------------%
