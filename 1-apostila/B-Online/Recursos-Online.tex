...
%    \item \href{http://onlinemschool.com/math/assistance/equation/gaus}
%               {onlinemschool.com/math/assistance/equation/gaus} \\
%        Calculadora online que utiliza o método de Gauss para resolver
%        um sistema linear mostrando os cálculos passo a passo.
\end{itemize}
...
Aulas da disciplina de Cálculo 4 do CEFET-MG gravadas pelo professor J. L. Acebal:
\begin{listlinks}
