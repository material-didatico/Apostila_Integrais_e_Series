...
\begin{exercise}
  ...
  \begin{answer}
A área dentro do círculo e acima da parábola é $2\pi +\frac{4}{3}$e a área dentro do círculo e abaixo da parábola é $6\pi -\frac{4}{3}$.
  \end{answer}
\end{exercise}
%--------------------------------------------------------------------------------
\begin{exercise}
Verifique se a integral imprópria $\int_{-1}^1 \frac{1}{x^2-2x} dx$ é convergente e em caso afirmativo calcule seu valor.
\begin{answer}
