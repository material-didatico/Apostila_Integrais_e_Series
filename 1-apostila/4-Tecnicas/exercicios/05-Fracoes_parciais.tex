...
%------------------------------------------------------------------------------%
\begin{exercise}
Usando frações parciais, calcule as seguintes integrais.
\begin{mathlist}
...
\begin{exercise}A integral \(\int \frac{\arctan(x)}{x^2}dx\) pode ser resolvida usando
  ...
  necessário usar uma substituição simples. Resolva essa integral.
  Além disso, mostre que a integral $\int_1^\infty \frac{\arctan(x)}{x^2}dx$
  é convergente e vale $\frac{\pi}{4}+ \frac{1}{2}\ln2$.
\end{exercise}
