...
%------------------------------------------------------------------------------%
\begin{exercise}
Determine se a $ \int_{0}^{\infty} \sin^2(x) dx$ integral é convergente
ou divergente. Caso seja convergente, calcule o valor dessa integral.
\begin{answer}
divergente.
\end{answer}
\end{exercise}
...
\begin{alphalist}
    ...
    \item $A=\sqrt{2}-1$ e $V=\pi(2\sqrt{2}- \frac{5}{2})$
\end{alphalist}
\end{answer}
\end{exercise}
