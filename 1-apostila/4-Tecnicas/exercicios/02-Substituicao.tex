...
\begin{mathlist}
  ...
  \item \int_{\frac{1}{6}}^{\frac{1}{2}} \csc(\pi t) \cot(\pi t)dt
...
%----------------------------------------------------------------------------
\begin{exercise} Calcule a área da região delimitada pelas curvas
  $y=\tan(x)$, $ y=2\sin(x)$, $-\frac{\pi}{3} \leq x \leq \frac{\pi}{3}$
\begin{answer}
$2-2\ln 2$
\end{answer}
\end{exercise}
...
\begin{mathlist}
  ...
  \item \frac{4}{e}
  \item x \arctan(\sqrt{x})- \sqrt{x}+ \arctan(\sqrt{x})+C= (\arctan(\sqrt{x})(x+1)- \sqrt{x}+C
\end{mathlist}
\end{answer}
\end{exercise}
