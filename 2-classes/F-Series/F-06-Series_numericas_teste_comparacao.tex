...
\begin{frame}{Exemplo \theexemplo}
  ...
  \begin{align*}
    ...
    \onslide<+->{& = \lim_{n\to\infty} \dfrac{\;\frac{1}{\ln n}\;}{\frac{1}{n}}         \\}
    \onslide<+->{& = \lim_{n\to\infty} \frac{n}{\ln n}                                  \\}
    \onslide<+->{& = \lim_{x\to\infty} \frac{x}{\ln x}                                  \\}
    \onslide<+->{& = \lim_{x\to\infty} \frac{1}{\sfrac{1}{x}} & \text{Usando l'Hopital} \\}
